...
namespace NotificationService.Infrastructure.Kafka.Consumers.Manual
{
    public class ManualNotifycationConsumer : IEventConsumer
    {
        private readonly IConsumer<string, string> _consumer;
        private readonly IServiceProvider _serviceProvider;
        private readonly KafkaSettings _kafkaSettings;

        public ManualNotifycationConsumer(IConfiguration config, IServiceProvider serviceProvider, IOptions<KafkaSettings> kafkaOptions)
        {
